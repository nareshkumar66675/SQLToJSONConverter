...
SELECT TypeDescription, Manufacturer, ModelType, 
case when mdl.mdl_long_name <> Model then mdl_long_name else Model end as Model,
GameHoldPC, HoldPC, MaxBet, LineConfiguration, GameCategory
...
And SITE_NUMBER in (1, 2, 3, 301, 302, 401, 404, 501, 502, 201, 202, 801, 802, 683, 601)
