...
CASE WHEN OPTN_CODE in ('ASSET.GMU.CRC.AUTH', 'ASSET.CASLESS.DISAB') THEN 
...
CASE WHEN OPTN.OPTN_CODE in ('ASSET.GMU.CRC.AUTH', 'ASSET.CASLESS.DISAB') THEN 
 ...
 ELSE
	(CASE WHEN AST_OPTN_VALUE = 'FLAG.NO' then 'No'
      ...
      ELSE ISNULL(AST_OPTN_VALUE, '') END)  END
